...
#define __GMP_CC "armv7a-cros-linux-gnueabi-gcc --sysroot=/home/garrett/Documents/steamlink-sdk/rootfs -marm -mfpu=neon -mfloat-abi=hard -std=gnu99"
#define __GMP_CFLAGS "-marm -O2 -pedantic -fomit-frame-pointer -march=armv7-a"
